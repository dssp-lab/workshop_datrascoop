...
The registration page is in spanish. For non-spanish speakers, refer to [this page]({{ site.baseurl }}{% link dssp-lab/workshop_datrascoop/_posts/help_registration.md %}) for a help on how to fill in the details of the registration.